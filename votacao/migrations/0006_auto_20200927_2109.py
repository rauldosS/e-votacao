...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('votacao', '0005_auto_20200927_2108'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='eleicaoestadual',
            options={'ordering': ('ano', 'tipo'), 'verbose_name': 'Eleição estadual', 'verbose_name_plural': 'Eleições estaduais'},
        ),
        migrations.AlterModelOptions(
            name='eleicaofederal',
            options={'ordering': ('ano', 'tipo'), 'verbose_name': 'Eleição federal', 'verbose_name_plural': 'Eleições federais'},
        ),
